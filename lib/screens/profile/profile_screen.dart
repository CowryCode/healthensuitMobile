...
//  const PatientScreen({Key? key, this.onMenuTap, this.email, this.name, required this.patientProfile}) : super(key: key);
...
class _PatientScreenState extends State<PatientScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: NavigationDrawerWidget(indexNum: 1, patientprofile: profile,),
      appBar: AppBar(
        ...
        child: Container(
          ...
          child: Column(
            ...
            //  PatientName(patientNameText: widget.name, buttonEvent: (){},),
              PatientName(patientNameText: "${profile.firstName} ${profile.lastName}", buttonEvent: (){},),
             ...
             // RowItem(rowIcon: Icons.phone_android, rowText: "902-111-3333",),
              RowItem(rowIcon: Icons.phone_android, rowText: "${profile.phoneNumber}",),


              SizedBox(height: 20.0),
            //  RowItemEdit(rowIcon: Icons.email, rowText: widget.email, buttonIcon: Icons.edit, buttonEvent: (){},),
              RowItemEdit(rowIcon: Icons.email, rowText: "${profile.email}", buttonIcon: Icons.edit, buttonEvent: (){},),
